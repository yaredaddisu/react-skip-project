...
const SkipCard: React.FC<SkipCardProps> = ({ skip, isSelected, onSelect, viewMode, handleContinue }) => {
  ...
  return (
    <div
      className={cn(
        "relative bg-white rounded-2xl border-2 transition-all duration-300 cursor-pointer group hover:shadow-2xl",
        isSelected
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-t-2xl">
        <div className={cn(
          "aspect-video bg-gradient-to-br transition-all duration-300 flex items-center justify-center",
          isSelected
